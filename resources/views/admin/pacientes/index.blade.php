            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.pacientes.create') }}" class="btn btn-primary">Registrar
                ...
                <div class="card-body">
                    ...
                    @endif
                    <table id="pacientes" class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            @foreach ($pacientes as $paciente)
                                <tr>
                                    ...
                                    <td scope="row">{{ $paciente->cc }}</td>
                                    <td scope="row">{{ $paciente->celular }}</td>
                                    <td scope="row">{{ $paciente->fecha_nacimiento }}</td>
                                    <td scope="row">{{ $paciente->direccion }}</td>
                                    {{-- <td scope="row">{{ $paciente->user->email }}</td> --}}
                                    <td scope="row">
